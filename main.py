...
try: app_id = int(os.environ.get("app_id", "29236719"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "1ccf1bd0a86af974e3210a55f662c062")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7111778667:AAFsMf8jxJ0aZ_UveUIQ-ExTkwE2rBzEUcQ")
